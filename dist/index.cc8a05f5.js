...
(function(win, doc, undefined) {
    ...
    RGraph.SVG.clone = RGraph.SVG.arrayClone = function(obj) {
        ...
        if (RGraph.SVG.isArray(obj)) {
            var temp = [];
            for(var i1 = 0, len = obj.length; i1 < len; ++i1){
                if (typeof obj[i1] === "number") temp[i1] = function(arg) {
                    return Number(arg);
                }(obj[i1]);
                else if (typeof obj[i1] === "string") temp[i1] = function(arg) {
                    return String(arg);
                }(obj[i1]);
                else if (typeof obj[i1] === "function") temp[i1] = obj[i1];
                else temp[i1] = RGraph.SVG.arrayClone(obj[i1]);
            }
        } else if (typeof obj === "object") {
            var temp = {};
            for(var i1 in obj)if (typeof i1 === "string") temp[i1] = obj[i1];
        }
        return temp;
    };
    //
    ...
    RGraph.SVG.drawTitle = function(obj) {
        ...
        if (!RGraph.SVG.isNull(obj.properties.key)) y1 -= 20;
...
*/ };
    ...
    RGraph.SVG.stringsToNumbers = function(str) {
        ...
        if (typeof str === "object" && !RGraph.SVG.isNull(str)) for(var i1 = 0, len = str.length; i1 < len; i1 += 1)str[i1] = RGraph.SVG.stringsToNumbers(str[i1], sep);
        return str;
    };
    ...
    RGraph.SVG.responsive = function(conf) {
        ...
        for(var i1 = 0; i1 < conf.length; ++i1){
            ...
            conf[i1].minWidth = RGraph.SVG.isNull(conf[i1].minWidth) ? 0 : conf[i1].minWidth;
            conf[i1].maxWidth = RGraph.SVG.isNull(conf[i1].maxWidth) ? 100000 : conf[i1].maxWidth;
    ...
    RGraph.SVG.responsiveOld = function(conf) {
        ...
        var func = function() {
            ...
            //
            if (!matched && (document.documentElement.clientWidth <= conf[i1].maxWidth || RGraph.SVG.isNull(conf[i1].maxWidth))) {
                matched = true;
                // If a width is defined for this rule set it
...
//# sourceMappingURL=index.cc8a05f5.js.map
