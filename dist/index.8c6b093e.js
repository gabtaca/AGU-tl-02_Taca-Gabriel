    ...
    RGraph.arrayRemoveNull = function() {
        ...
        if (RGraph.isArray(args.source)) {
            ...
            for(let i1 in args.source){
                if (RGraph.isNull(args.source[i1])) {
        ...
        //
            ...
            for(let i1 in args.source){
                ...
                else if (!RGraph.isNull(args.source[i1])) Object.defineProperty(arr, i1, {
                    value: args.source[i1]
                });
                else if (RGraph.isNull(args.source[i1])) {
...
//# sourceMappingURL=index.8c6b093e.js.map
